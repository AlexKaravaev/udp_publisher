...
void Input::publishPacket(int dataLength)
{
  std_msgs::UInt8MultiArray data_msg;

  // Construct message and publish it to topic
...
int Input::getSockData()
{
  ...
  while (true)
  {
    ...
    //Check if read was succesfull and publish if was
    if (nbytes < 0)
    {
